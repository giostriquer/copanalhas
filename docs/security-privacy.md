...
Dashboard rendering may fetch current Discord display names and weekly profile
card display avatars for readability. These are used only to render the outgoing
Discord image/message and are not stored as durable profile records.
