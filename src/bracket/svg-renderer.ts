...
const flagWidth = 25;
const flagHeight = 17;
const teamTextMaxLength = 15;
const entrantAreaX = 4;
const entrantAreaWidth = r32Width - 64;
const pathScoreColumnWidth = 36;
const r32ToPathGap = 28;
const pathColumnGap = 48;
const connectorColor = "#4f8f38";
const leftR32X = marginX;
const leftR16X = leftR32X + r32Width + r32ToPathGap;
const leftQfX = leftR16X + r16Width + pathColumnGap;
const leftSfX = leftQfX + qfWidth + pathColumnGap;
